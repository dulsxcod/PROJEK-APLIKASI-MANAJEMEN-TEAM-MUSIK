        ...
        <section class="row g-4 mt-2 justify-content-center">
            ...
            <div class="col-12 col-lg-7 col-xl-8 mx-auto">
                ...
                <div class="glass-panel overflow-hidden mb-4">
                    <div class="px-4 py-3 d-flex justify-content-between align-items-center border-bottom border-white border-opacity-10">
                        <h3 class="h5 fw-bold mb-0">Data Anggota</h3>
                    </div>
                                ...
                                if (mysqli_num_rows($query_anggota) > 0) {
                                    ...
                                    while ($row_anggota = mysqli_fetch_assoc($query_anggota)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-3"><span class="small text-white fw-medium"><?= $row_anggota['NamaLengkap']; ?></span></td>
                                            <td class="px-4 py-3"><span class="small text-white"><?= $row_anggota['TempatLahir']; ?></span></td>
                                            <td class="px-4 py-3"><span class="small text-white"><?= $row_anggota['TanggalLahir']; ?></span></td>
                                            <td class="px-4 py-3"><span class="small text-white"><?= $row_anggota['JenisKelamin']; ?></span></td>
                                            <td class="px-4 py-3"><span class="small text-white"><?= $row_anggota['NoHP']; ?></span></td>
                                            <td class="px-4 py-3"><span class="small text-white"><?= $row_anggota['Role']; ?></span></td>
                                            <td class="px-4 py-3"><span class="small text-white"><?= $row_anggota['Bagian']; ?></span></td>
                                        </tr>
                                        <?php
                                    }
                                } else {
                                    echo '<tr><td colspan="8" class="text-center py-4 text-muted small">Belum ada data anggota yang terdaftar.</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($query_job) > 0) {
                                    ...
                                    while ($row_job = mysqli_fetch_assoc($query_job)) {
                                        ...
                                        <tr>
                                            <td class="px-4 py-3 small text-white"><?= $no++; ?></td>
                                            <td class="px-4 py-3"><span class="small text-white fw-medium"><?= $row_job['NamaTuanRumah']; ?></span></td>
                                            <td class="px-4 py-3"><span class="small text-white"><?= $row_job['Tanggal']; ?></span></td>
                                            <td class="px-4 py-3"><span class="small text-white"><?= $row_job['Alamat']; ?></span></td>
                                            <td class="px-4 py-3"><span class="small text-white"><?= $row_job['NamaGroup']; ?></span></td>
                                            <td class="px-4 py-3"><span class="small text-white"><?= $row_job['Seragam']; ?></span></td>
                                        </tr>
                                        <?php
                                    }
                                } else {
                                    echo '<tr><td colspan="6" class="text-center py-4 text-muted small">Belum ada data job terdaftar.</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
                ...
                <div class="glass-panel overflow-hidden mb-5">
                    <div class="px-4 py-3 d-flex justify-content-between align-items-center border-bottom border-white border-opacity-10">
                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($query_kas) > 0) {
                                    ...
                                    while ($row_kas = mysqli_fetch_assoc($query_kas)) {
                                        ...
                                        <tr>
                                            <td class="px-4 py-3 small text-white"><?= $no++; ?></td>
                                            <td class="px-4 py-3"><span class="small text-white fw-medium"><?= $row_kas['Tanggal']; ?></span></td>
                                            <td class="text-success"><?= "Rp " . number_format($row_kas['Pemasukan'], 0, ',', '.'); ?></td>
                                            <td class="text-danger"><?= "Rp " . number_format($row_kas['Pengeluaran'], 0, ',', '.'); ?></td>
                                            <td class="px-4 py-3"><span class="small text-white"><?= $row_kas['Keterangan']; ?></span></td>
                                            <td class="fw-bold" style="color: var(--accent-color);"><?= "Rp " . number_format($saldo_berjalan, 0, ',', '.'); ?></td>
                                        </tr>
                                        <?php
                                    }
                                } else {
                                    echo '<tr><td colspan="6" class="text-center py-4 text-muted small">Belum ada data kas.</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
                ...
                <h6 class="text-white fw-bold ms-1 mb-3">Buat Postingan?</h6>
                <div class="glass-panel p-4 mb-4">
                    <p class="mb-2 fw-semibold text-white text-truncate small">
                    ...
                    <form action="proses_post.php" method="POST">
                        <div class="d-flex gap-3 mb-3">
                            ...
                            <textarea name="isi_postingan" class="form-control form-control-dark" rows="3" placeholder="Ada pengumuman atau info update apa hari ini, <?= isset($row['NamaLengkap']) ? explode(' ', $row['NamaLengkap'])[0] : 'Admin'; ?>?" required></textarea>
                        </div>

        ...
        <section class="mt-4">
            <div class="glass-panel overflow-hidden">
                <div
                    ...
                    <h3 class="h5 fw-bold mb-0">Data Postingan</h3>
                    <a href="index.php"
                        ...
                        <div>
                            <p class="mb-0 fw-semibold text-white small">Tambah Postingan</p>
                            <span class="text-white text-xs" style="font-size:12px;">Posting sesuatu?</span>
                        </div>
                    </a>
                </div>
                    ...
                    <table class="table custom-table mb-0 align-middle">
                        <thead>
                            <tr>
                                ...
                                <th class="px-4 py-3">Isi Postingan</th>
                                <th class="px-4 py-3">File Media</th>
                                <th class="px-4 py-3">Tanggal Post</th>
                            ...
                            if (mysqli_num_rows($query_post) > 0) {
                                ...
                                while ($row_post = mysqli_fetch_assoc($query_post)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-3">
                                            <span class="small text-white fw-medium"><?= $row_post['user_id']; ?></span>
                                        </td>
                                        <td class="px-4 py-3"><span
                                                class="small text-white"><?= $row_post['isi_postingan']; ?></span></td>
                                        <td class="px-4 py-3"><span
                                                class="small text-white"><?= $row_post['file_media']; ?></span></td>
                                        <td class="px-4 py-3"><span
                                                class="small text-white"><?= $row_post['tanggal_post']; ?></span></td>
                                        <td class="px-4 py-3">
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="edit_postingan.php?id=<?= $row_post['id_post']; ?>"
                                                ...
                                                <a href="proses_hapus_postingan.php?id=<?= $row_post['id_post']; ?>"
                                                    class="btn btn-sm d-inline-flex align-items-center justify-content-center border border-white border-opacity-10 rounded-3 p-2"
                                                    title="Hapus Data"

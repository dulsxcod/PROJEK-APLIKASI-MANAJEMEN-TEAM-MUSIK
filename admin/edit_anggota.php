...
if (isset($_GET['id'])) {
    ...
    $query_edit = mysqli_query($conn, "SELECT * FROM anggota WHERE UserID = '$id'");
    $data_anggota = mysqli_fetch_assoc($query_edit);
...
<head>
    ...
    <style>
        ...
        /* Menimpa background form search tanpa menyentuh file PHP utama */
        .search-box {
    ...
    <aside class="d-flex flex-column justify-content-between py-4">
        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 p-3 glass-panel"
                        ...
                        <div class="overflow-hidden">
                            <p class="mb-0 fw-semibold text-white text-truncate small">
                                <?= isset($row['NamaLengkap']) ? $row['NamaLengkap'] : 'Admin'; ?></p>
            ...
            <nav class="px-2 d-flex flex-column gap-1">
                ...
                <a class="nav-link-custom active" href="anggota.php">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-4">
                            <div class="p-2.5 rounded-3" style="background: rgba(237,177,255,0.1);">
                                <span class="material-symbols-outlined"
                                    style="color: var(--accent-color)">person_add_alt_1</span>
                            </div>
                            <div>
                                <h2 class="h5 text-white mb-0 fw-bold">Edit Profil Musisi / Anggota</h2>
                                <p class="text-white small mb-0">Perbarui data informasi lengkap akun manajemen studio.
                                </p>
                            </div>
                        </div>

                        <form action="proses_edit_anggota.php" method="POST">
                            <input type="hidden" name="UserID" value="<?= $data_anggota['UserID']; ?>">

                            <div class="row g-3">
                                <div class="col-12 col-md-6">
                                    <label class="form-label text-white-50 small fw-medium">Username</label>
                                    <input type="text" name="Username"
                                        value="<?= htmlspecialchars($data_anggota['Username']); ?>"
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="form-label text-white-50 small fw-medium">Password <span
                                            class="text-info" style="font-size: 11px;">(Kosongkan jika tidak
                                            diubah)</span></label>
                                    <input type="password" name="Password"
                                        class="form-control bg-white bg-opacity-5 border-white border-opacity-10 text-black rounded-3 p-2.5 small"
                                        placeholder="Masukkan password baru" style="transition: all 0.2s;"
                                        onfocus="this.style.borderColor='var(--accent-color)'; this.style.boxShadow='0 0 0 0.25rem rgba(237,177,255,0.1)';"
                                        onblur="this.style.borderColor='rgba(255,255,255,0.1)'; this.style.boxShadow='none';">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="NamaLengkap"
                                        value="<?= htmlspecialchars($data_anggota['NamaLengkap']); ?>"
                                        class="form-control bg-white bg-opacity-5 border-white border-opacity-10 text-black rounded-3 p-2.5 small"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="TempatLahir"
                                        value="<?= htmlspecialchars($data_anggota['TempatLahir']); ?>"
                                        class="form-control bg-white bg-opacity-5 border-white border-opacity-10 text-black rounded-3 p-2.5 small"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="date" name="TanggalLahir" value="<?= $data_anggota['TanggalLahir']; ?>"
                                        class="form-control bg-white bg-opacity-5 border-white border-opacity-10 text-black rounded-3 p-2.5 small"
                                        required style="transition: all 0.2s;"
                                        onfocus="this.style.borderColor='var(--accent-color)'; this.style.boxShadow='0 0 0 0.25rem rgba(237,177,255,0.1)';"
                                        onblur="this.style.borderColor='rgba(255,255,255,0.1)'; this.style.boxShadow='none';">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <select
                                        class="form-select bg-white bg-opacity-5 border-white border-opacity-10 text-black rounded-3 p-2.5 small"
                                        name="JenisKelamin" style="transition: all 0.2s;"
                                        onfocus="this.style.borderColor='var(--accent-color)'; this.style.boxShadow='0 0 0 0.25rem rgba(237,177,255,0.1)';"
                                        onblur="this.style.borderColor='rgba(255,255,255,0.1)'; this.style.boxShadow='none';">
                                        <option value="Laki-laki" class="text-black"
                                            <?= ($data_anggota['JenisKelamin'] == 'Laki-laki') ? 'selected' : ''; ?>>
                                            Laki-laki</option>
                                        <option value="Perempuan" class="text-black"
                                            <?= ($data_anggota['JenisKelamin'] == 'Perempuan') ? 'selected' : ''; ?>>
                                            Perempuan</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="NoHP"
                                        value="<?= htmlspecialchars($data_anggota['NoHP']); ?>"
                                        class="form-control bg-white bg-opacity-5 border-white border-opacity-10 text-black rounded-3 p-2.5 small"
                                ...
                                <div class="col-12">
                                    <label class="form-label text-white-50 small fw-medium">Role Sistem</label>
                                    <select
                                        class="form-select bg-white bg-opacity-5 border-white border-opacity-10 text-black rounded-3 p-2.5 small"
                                        name="Role" style="transition: all 0.2s;"
                                        onfocus="this.style.borderColor='var(--accent-color)'; this.style.boxShadow='0 0 0 0.25rem rgba(237,177,255,0.1)';"
                                        onblur="this.style.borderColor='rgba(255,255,255,0.1)'; this.style.boxShadow='none';">
                                        <option value="Admin" class="text-black" <?= ($data_anggota['Role'] == 'Admin') ? 'selected' : ''; ?>>Admin</option>
                                        <option value="Musisi" class="text-black" <?= ($data_anggota['Role'] == 'Musisi') ? 'selected' : ''; ?>>Musisi</option>
                                        <option value="Staff" class="text-black" <?= ($data_anggota['Role'] == 'Staff') ? 'selected' : ''; ?>>Staff</option>
                                    </select>
                                </div>

                                <div class="col-12">
                                    <label class="form-label text-white-50 small fw-medium">Bagian / Posisi</label>
                                    <input type="text" name="Bagian"
                                        value="<?= htmlspecialchars($data_anggota['Bagian']); ?>"
                                        class="form-control bg-white bg-opacity-5 border-white border-opacity-10 text-black rounded-3 p-2.5 small"
                                        placeholder="Contoh: Gendang, Vocalist" required style="transition: all 0.2s;"
                                        onfocus="this.style.borderColor='var(--accent-color)'; this.style.boxShadow='0 0 0 0.25rem rgba(237,177,255,0.1)';"
                                        onblur="this.style.borderColor='rgba(255,255,255,0.1)'; this.style.boxShadow='none';">
                                </div>

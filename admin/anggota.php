            ...
            <div class="glass-panel overflow-hidden">
                <div
                    ...
                    <a href="tambah_anggota.php"
                        ...
                        <div>
                            <p class="mb-0 fw-semibold text-white small">Tambah Anggota Musisi</p>
                            <span class="text-white text-xs" style="font-size:12px;">Tambah Anggota Team Musik</span>
                        </div>
                    </a>
                </div>
                            ...
                            if (mysqli_num_rows($query_anggota) > 0) {
                                ...
                                while ($row_anggota = mysqli_fetch_assoc($query_anggota)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-3">
                                            <span class="small text-white fw-medium"><?= $row_anggota['NamaLengkap']; ?></span>
                                        </td>
                                        <td class="px-4 py-3"><span
                                                class="small text-white"><?= $row_anggota['TempatLahir']; ?></span></td>
                                        <td class="px-4 py-3"><span
                                                class="small text-white"><?= $row_anggota['TanggalLahir']; ?></span></td>
                                        <td class="px-4 py-3"><span
                                                class="small text-white"><?= $row_anggota['JenisKelamin']; ?></span></td>
                                        <td class="px-4 py-3"><span class="small text-white"><?= $row_anggota['NoHP']; ?></span>
                                        </td>
                                        <td class="px-4 py-3"><span class="small text-white"><?= $row_anggota['Role']; ?></span>
                                        </td>
                                        <td class="px-4 py-3"><span
                                                class="small text-white"><?= $row_anggota['Bagian']; ?></span></td>
                                        <td class="px-4 py-3">
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="edit_anggota.php?id=<?= $row_anggota['UserID']; ?>"
                                                ...
                                                <a href="proses_hapus_anggota.php?id=<?= $row_anggota['UserID']; ?>"
                                                    class="btn btn-sm d-inline-flex align-items-center justify-content-center border border-white border-opacity-10 rounded-3 p-2"
                                                    title="Hapus Data"
